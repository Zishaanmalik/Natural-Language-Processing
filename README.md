...
You’ll find the following key parts:

### 🧰 Core NLP Notebooks
- **Text Preprocessing.ipynb** — How to clean and prepare raw text  
- **Vectorization_Techniques.ipynb** — Turning text into numbers  
- **gensim.ipynb** — Using gensim for Word2Vec and related embedding work  
- **pos-tagging.ipynb** — Part-of-speech tagging basics
...
- **models/** — Saved vector models, embeddings, and any trained artifacts

### ✨ Other Files
- `.idea/` and `.ipynb_checkpoints/` — IDE and notebook metadata

---

## 🧠 What This Repository Shows

This is not a single project — it’s a **learning collection** that walks through many core NLP concepts:
...
Words and text can’t be fed to models directly.  
This repo shows:
- Bag of Words
- TF-IDF
- Word2Vec embeddings
...
Understanding grammar can help with certain downstream tasks — so there’s an example of part-of-speech tagging too.

---

### 📌 Word2Vec Explorations
